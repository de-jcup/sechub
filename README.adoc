...
== Sundown information
After seven years, the project has unfortunately been discontinued. Mercedes-Benz has decided to cease development and maintenance of SecHub. Therefore, the project has been archived on GitHub and the issues have been deactivated.

It was a pleasure to contribute to this project, and we regret its discontinuation. We would also like to thank everyone who worked with us on this open-source solution.

A potential successor project, Vufio, is currently under development but it is still in its early stages. Those interested can find more information at:

- http://www.vulfio.org or 
- https://vulfio.github.io/website/ 
